...
public class LetterCombinerMenu extends AbstractContainerMenu {
  private final CraftingContainer craftSlots = new TransientCraftingContainer(this, 9, 2);
  ...
  private Item getItemInMods(String resourceName) {
    ...
    for (IModInfo modInfo : mods) {
      ResourceLocation location = ResourceLocation.fromNamespaceAndPath(modInfo.getModId(), resourceName);
